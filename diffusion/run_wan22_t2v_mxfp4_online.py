"""
Wan2.2 T2V (Text-to-Video) Online MXFP4 量化推理脚本
...
def main():
    parser = argparse.ArgumentParser(description="Wan2.2 T2V Online MXFP4 双级量化视频生成")
    ...
    parser.add_argument("--seed", type=int, default=42,
                        help="随机种子")
    parser.add_argument("--output-dir", type=str, default="./outputs_t2v_mxfp4_online",
                        help="输出目录")
