"""
Wan2.2 TI2V (Text-Image-to-Video) MXFP4 离线预量化加载推理脚本
...
def main():
    parser = argparse.ArgumentParser(description="Wan2.2 TI2V MXFP4 离线预量化加载视频生成")
    parser.add_argument("--model-path", type=str,
                        default="/home/weights/Wan2.2-TI2V-5B-Diffusers-MXFP4",
    ...
    parser.add_argument("--seed", type=int, default=42,
                        help="随机种子")
    parser.add_argument("--output-dir", type=str, default="./outputs_mxfp4_offline",
                        help="输出目录")
