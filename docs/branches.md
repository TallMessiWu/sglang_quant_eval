...
| SGLang [#32266](https://github.com/sgl-project/sglang/pull/32266) — Qwen3.5 MoE W8A8 MXFP8 | Open Draft | `junlin_qwen3.5_moe_w8a8` | `a37cf13b2f` | `sglang/qwen3.5_moe_w8a8/` |
| SGLang [#32601](https://github.com/sgl-project/sglang/pull/32601) — Qwen3.5 MoE W4A8 MXFP | Open Draft | `junlin_qwen3.5_moe_w4a8` | `6bcf2af6a2` | `sglang/qwen3.5_moe_w4a8/` |
| SGLang [#32602](https://github.com/sgl-project/sglang/pull/32602) — Qwen3.5 MoE W4A4 MXFP4 | Open Draft | `junlin_qwen3.5_moe_w4a4` | `da6cbda3ed` | `sglang/qwen3.5_moe_w4a4/` |
...
```text
#32266 / junlin_qwen3.5_moe_w8a8
  └─ #32601 / junlin_qwen3.5_moe_w4a8
       └─ #32602 / junlin_qwen3.5_moe_w4a4
