"""
Wan2.2 T2V (Text-to-Video) Online MXFP8 量化推理脚本 (带 Profiling)
...
def main():
    parser = argparse.ArgumentParser(description="Wan2.2 T2V Online MXFP8 量化视频生成 (Profiling)")
    ...
    print(f"量化方式: Online MXFP8 (Profiling)")
    ...
    print("正在加载模型（Online MXFP8 量化 + Profiling）...")
